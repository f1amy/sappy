...
while answer in['Y','y']:
    print("\n  Game \"Sappy\".")
    print("\n  Version 1.1.4 Build#3-Easy (08.12.2016)")
    print("\n  Deverlopers: Bryzgalov Fedor(IS-205), Putimtsev Yuri(IS-205).")
    ...
    if time==0:
        while True:
            N=int(input('\n  Enter the dimensions of the field (number).\n> '))
            if N>7:
                N=int(input("  The program supports a maximum field of 7x7, try again.\n> "))
            elif N<2:
                N=int(input("  The program supports the field at least 2x2, try again.\n> "))
            elif N>=2 and N<4:
                print("  Note! For normal operation of the program is better to choose 4x4 box above.")
                break
            else:
                break
        print("\n  You have chosen the dimension of the field ",N,"x",N,sep="",end=".\n")
